...
def achieved_wgan_generated_data(input_file, sample_ratio=1, training_set_percent=0.9, critic=1,
...
if __name__ == '__main__':
    ...
    all_file_lst = achieved_wgan_generated_data(reduced_features_data_file, sample_ratio, training_set_percent, critic,
                                                distance_threshold)
    for file_tmp in all_file_lst:
        print(file_tmp)
