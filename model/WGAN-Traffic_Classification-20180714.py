...
def run_main(input_file, num_features):
    ...
    # input_file = '../data/attack_normal_data/benigin_data.csv'
    print(input_file)
...
def two_stages_online_evaluation(benigin_model, attack_model, input_file):
    """

    :param benigin_model:
    :param attack_model:
    :param input_file: mix 'benigin_data' and 'attack_data'
    :return:
    """
    data = []
    ...
    for i in range(len(data)):
        ...
        threshold1 = benigin_model.D(x)
        if (threshold1 > 0.4) and (threshold1 < 0.6):
            y_pred = '1'
            # print('benigin_data', y, y_pred)   # attack =0, benigin = 1
        else:
...
if __name__ == '__main__':
    ...
    input_file = '../data/attack_normal_data/benigin_data.csv'
    benigin_model, benigin_test_loader = run_main(input_file, num_features=41)
    ...
    two_stages_online_evaluation(benigin_model, attack_model, input_file)
