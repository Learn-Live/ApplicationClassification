...
from utilities.preprocess import TrafficDataset
...
with torch.no_grad():
    ...
    print('Test Accuracy of the proposed_algorithms on the 10000 test images: {} %'.format(100 * correct / total))

# Save the proposed_algorithms checkpoint
torch.save(model.state_dict(), 'proposed_algorithms.ckpt')
