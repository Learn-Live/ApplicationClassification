...
if __name__ == '__main__':
    ...
    # features_file = '../input_data/data_split_train_v2_711/train_1pkt_images.csv'
    # labels_file = '../input_data/data_split_train_v2_711/train_1pkt_labels.csv'
    ...
    for i in [1, 3, 5, 8, 10]:
        features_file_i = '../input_data/data_split_train_v2_711/train_%dpkt_images.csv' % i
        labels_file_i = '../input_data/data_split_train_v2_711/train_%dpkt_labels.csv' % i
