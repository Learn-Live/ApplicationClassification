...
from utilities.preprocess import normalize_data
...
def split_train_test(dataset, split_percent=0.7, shuffle=True, seed=42):
    ...
    :return:
    """
    # Creating input_data indices for training and validation splits:
    ...
    # train_loader = torch.utils.input_data.DataLoader(dataset, batch_size=batch_size,
    #                                            sampler=train_sampler)
    # validation_loader = torch.utils.input_data.DataLoader(dataset, batch_size=batch_size,
...
if __name__ == '__main__':
    ...
    # dataloader = torch.utils.input_data.DataLoader(dataset, batch_size=30, shuffle=True, num_workers=4)
