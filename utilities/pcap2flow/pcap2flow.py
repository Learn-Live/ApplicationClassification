...
from utilities.preprocess import compute_mean
...
def extract_packet_payload(f_name, txt_f_name):
    ...
    :return:
    """
    # cmd = """tshark -r %s -T fields -e input_data -w %s""" % (
    #     f_name, txt_f_name)
...
if __name__ == '__main__':
    ...
    input_file = '../input_data/history_data/Skype_Voice_Workstation.pcap'
    pcap2sessions(input_file)

    # pcap_file_name = '../input_data/WorldOfWarcraft.pcap'
    # pcap_file_name = '../input_data/BitTorrent.pcap'
    # extract_packet_payload(pcap_file_name, 'payload.txt')
    # exit(-1)
    # pcap_file_name = '../input_data/FILE-TRANSFER_gate_FTP_transfer.pcap'
    # # pcap_file_name='../input_data/VIDEO_Vimeo_Gateway.pcap'
    # pcap_file_name='../input_data/P2P_tor_p2p_multipleSpeed.pcap'
    root_dir = '../results'
